...
**Note:** The first digits (0.273036665085...) are identical in both outputs. This is the fixed part of the method, representing the baseline DX offset. The cryptographic functions encode information by adding fine-grained, high-precision decimal components to this base.
